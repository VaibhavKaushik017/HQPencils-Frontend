    ...
    <div className="w-[100%] pb-24">
      <section className="rounded-3xl flex bg-[#ececec] max-md:p-4 p-8 container mx-auto items-center">
        <div className="w-1/2 text-center">
          ...
          <h1 className="text-7xl max-md:text-3xl max-lg:text-5xl font-bold my-2">
            CUSTOM
          </h1>
          <p className="max-md:text-xs text-gray-500 tracking-widest">
            PENCIL SKETCH
        ...
        <div className="flex justify-center gap-[1px] w-1/2">
          <img
            className="h-[400px] max-sm:h-[180px] max-md:h-[250px] max-lg:h-[320px]"
            src="girl.png"
          />
          <img
            className="max-lg:h-[320px] h-[400px] max-sm:h-[180px] max-md:h-[250px]"
            src="virat.png"
          />
        </div>
      </section>
