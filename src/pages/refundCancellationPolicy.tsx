function Disclaimer() {
  return (
    <div className="py-24 w-[90%] flex flex-col gap-2 mx-auto">
      <h1 className="text-center text-2xl font-semibold">Return and Refund Policy</h1>
      <p>Last updated: May 12, 2024</p>
      <p>Thank you for shopping at HQPencils.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to HQPencils.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to HQPencils, accessible from{" "}
            <a
              href="https://hqpencils.com"
      ...
      <ul>
        <li>
          ...
          <a
            href="https://hq-pencils-frontend.vercel.app/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://hq-pencils-frontend.vercel.app/contact
          </a>
        </li>
      </ul>
      <p>
      ...
      <p>A Person from our team will pickup the product from the address</p>
      <p>
